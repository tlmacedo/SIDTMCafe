...
/**
 *  RecepcaoEvento4CallbackHandler Callback class, Users can extend this class and implement
...
public abstract class RecepcaoEvento4CallbackHandler {
     ...
     */
    public RecepcaoEvento4CallbackHandler(Object clientData) {
    ...
    public void receiveResultnfeRecepcaoEvento(
        webService.nfe.RecepcaoEvento4Stub.NfeResultMsg result) {
    }
