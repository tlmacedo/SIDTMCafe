...
public class NfeInutilizacao4Stub extends org.apache.axis2.client.Stub {
     ...
     *
     * @see webService.nfe.NfeInutilizacao4#nfeInutilizacaoNF
     * @param nfeDadosMsg0
     */
    public webService.nfe.NfeInutilizacao4Stub.NfeResultMsg nfeInutilizacaoNF(
        webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg nfeDadosMsg0)
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    webService.nfe.NfeInutilizacao4Stub.NfeResultMsg.class,
                    getEnvelopeNamespaces(_returnEnv));

            return (webService.nfe.NfeInutilizacao4Stub.NfeResultMsg) object;
     ...
     *
     * @see webService.nfe.NfeInutilizacao4#startnfeInutilizacaoNF
     * @param nfeDadosMsg0
     */
    public void startnfeInutilizacaoNF(
        webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg nfeDadosMsg0,
        final webService.nfe.NfeInutilizacao4CallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeInutilizacao4/nfeInutilizacaoNF");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                public void onMessage(
                    ...
                    try {
                        ...
                        callback.receiveResultnfeInutilizacaoNF((webService.nfe.NfeInutilizacao4Stub.NfeResultMsg) object);
    ...
    private org.apache.axiom.om.OMElement toOM(
        webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
        webService.nfe.NfeInutilizacao4Stub.NfeResultMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(webService.nfe.NfeInutilizacao4Stub.NfeResultMsg.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg.MY_QNAME,
                    factory));
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        throws org.apache.axis2.AxisFault {
        try {
            if (webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg.class.equals(
                        type)) {
                return webService.nfe.NfeInutilizacao4Stub.NfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

            if (webService.nfe.NfeInutilizacao4Stub.NfeResultMsg.class.equals(
                        type)) {
                return webService.nfe.NfeInutilizacao4Stub.NfeResultMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
